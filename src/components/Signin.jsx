...
class Signin extends Component {
    ...
    onSignin(e) {
        ...
        // Comprueba si es un usuario válido de la base de datos
    ...
    checkLogin(res, username) {
        ...
        //Si no, tratar el error (mostrarlo en un 'Alert')...
        else {
            this.setState({
                            ...
                            <Form>
                                <FormGroup>
                                    ...
                                    <Input type="text" name="username" id="aUsername"
                                            placeholder="Introduce tu username" onChange={this.handleUsernameChange} required/>
                                </FormGroup>
                
                                <FormGroup>
                                    <Label for="aPassword">Password</Label>
                                    <Input type="password" name="password" id="aPassword"
                                            placeholder="Introduce tu password" onChange={this.handlePasswordChange} required/>
                                </FormGroup>
